...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MDIA] = LAYOUT_moonlander(
        ...
        _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, _______,           _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, KC_MPLY,
        _______, _______, _______, _______, _______, KC_WH_D,                             _______, _______, KC_MSTP, _______, _______, _______,
        _______, _______, _______, KC_BTN1, KC_BTN2,          _______,           _______,          _______, _______, _______, _______, _______,
                                            KC_BTN1, _______, _______,           _______, _______, KC_BTN2
    ),
